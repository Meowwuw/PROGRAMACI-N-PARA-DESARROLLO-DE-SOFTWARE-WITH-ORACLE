...
------------------dos insert into a cada table---------------------
INSERT INTO cliente (nombre, apellido, correo, ciudad) VALUES
  ('David',  'manihuari',  'XD@pachamanca.com',  'Huanuco'),
  ('Harim', 'ÑA', 'luis@correo.com', 'Lima');

-----------------------------------------------------------
INSERT INTO producto (nombre, categoria, precio, stock) VALUES
  ('Mouse logitech', 'Accesorios',    120,  50),
  ('Teclado DELL',   'Accesorios',   150, 20),
