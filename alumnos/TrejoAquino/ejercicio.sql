CREATE SCHEMA IF NOT EXISTS a_trejo;
...
INSERT INTO cliente (nombre, apellido, correo, ciudad) VALUES
  ('Carlos', 'Noriega', 'carlos@correo.com','Pachitea'),
  ('Leonardo','Lopes','leonardo@correo.com','Pucallpa');
INSERT INTO producto (nombre, categoria, precio, stock) VALUES
  ('Laptop Ryzen 5',       'Computo',    2499.00,  8),
  ('Mouse Michi inalambrico',    'Accesorios',   59.90, 40),
  ('celular samsung g24',	'dispositivo',	1234.90, 23),
  ('lavadora samsung', 'electro domestico',	2435.75, 18),
...
SELECT nombre, stock
FROM producto
WHERE categoria = 'Computo' AND stock < 700;

-- >>> TE TOCA A TI (2):
-- a) Muestra los productos que cuestan mas de 500 soles.
SELECT nombre, stock
FROM producto
WHERE categoria = 'Computo' AND stock > 500;
