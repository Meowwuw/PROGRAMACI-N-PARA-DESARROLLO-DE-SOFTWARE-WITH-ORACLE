...
select * from pedido where fecha between '2026-06-01' and '2026-06-31';
...
select * from cliente;
 ...
 select nombre,apellido,ciudad from cliente where ciudad ='pucallpa' or 
...
--     RESPUESTA: esto muestra los productos que no son de computo o de monitores.
select * from producto
...
select * from cliente where lower(apellido) like 'q%';
...
--      RESPUESTA:
RESPUESTA: Porque NULL significa que no hay un valor. No se puede comparar con =, por eso se debe usar IS NULL.
