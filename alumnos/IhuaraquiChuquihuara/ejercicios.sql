-- CREATE SCHEMA IF NOT EXISTS a_ihuaraqui; --
-- SET search_path TO a_ihuaraqui;
...
INSERT INTO cliente (nombre, apellido, correo, ciudad) VALUES
  ...
  ('Coraima', 'Fuster',   'cora@correo.com', 'Ucayali'),
  ('Maycol', 'Ihuaraqui',   'maycol@correo.com', 'Tumbes');
...
INSERT INTO producto (nombre, categoria, precio, stock) VALUES
  ...
  ('Teclado 17 pulgadas',  'Accesorios', 119.90,  10),
  ('Impresora', 'Accesorois', 500.00, 20);
, 
