...
CREATE SCHEMA IF NOT EXISTS a_sangama;

-- Se ejecuta CADA VEZ que abres DBeaver:
SET search_path TO a_sangama;
...
INSERT INTO cliente (nombre, apellido, correo, ciudad) VALUES
  ...
  ('Carlos', 'Arevalo', 'carlos@correo.com', 'Piura'),
  ('Marco', 'Torres', 'marco@correo.com' ,'Tacna'),
  ('David', 'Sangama', 'david@correo.com', 'Ucayali');
...
INSERT INTO producto (nombre, categoria, precio, stock) VALUES
  ...
  ('Teclado Wooting', 'Accesorios', 199.90, 5),
  ('MousePad XL', 'Accesorios', 124.90, 15);
