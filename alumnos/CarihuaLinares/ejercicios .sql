create schema if not exists a_linares
...
INSERT INTO cliente (nombre, apellido, correo, ciudad) VALUES
  ('tania', 'linares',  'linares@correo.com',    'pucallpa'),
  ('jamer', 'linares',  'jamerxr@correo.com',    'san martin');
...
INSERT INTO producto (nombre, categoria, precio, stock) VALUES
  ...
  ('Mouse Michi inalambrico',   'Accesorios',   59.90, 40),
  ('Monitor 24 pulgadas',       'Monitores',   749.50, 12),
  ('teclado lenovo inalanbrico', 'teclado',      58.99, 12),
  ('monitor samsung 12 pulgadas','monitor',    450.99, 14);
