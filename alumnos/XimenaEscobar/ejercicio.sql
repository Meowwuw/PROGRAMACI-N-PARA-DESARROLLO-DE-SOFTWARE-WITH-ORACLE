...
CREATE SCHEMA IF NOT EXISTS a_lozada;

-- Se ejecuta CADA VEZ que abres DBeaver:
SET search_path TO a_lozada;
...
INSERT INTO cliente (nombre, apellido, correo, ciudad) VALUES
 ('ximena','lozada','ximenalozada@correo.com','pucallpa'),
 ('Matheus','jaramillo','matehus@correo.com','hoyada');
...
INSERT INTO producto (nombre, categoria, precio, stock) values
  ('Silla Ergonómica', 'Muebles', 180.00, 30),
  ('Auriculares Inalámbricos', 'Accesorios', 45.99, 50);
...
FROM producto
WHERE categoria = 'Monitores' AND precio > 500;
