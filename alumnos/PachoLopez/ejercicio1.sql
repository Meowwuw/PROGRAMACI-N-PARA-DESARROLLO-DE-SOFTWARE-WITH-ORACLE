...
CREATE SCHEMA IF NOT EXISTS a_pacho;

-- Se ejecuta CADA VEZ que abres DBeaver:
SET search_path TO a_pacho;
...
INSERT INTO cliente (nombre, apellido, correo, ciudad) VALUES
  ...
  ('Leo', 'Pacho', 'meganpacho@gmail.com', 'Pucallpa'),
  ('Alex', 'Jose', 'Alexjose@gmail.com', 'Arequipa');
...
INSERT INTO producto (nombre, categoria, precio, stock) VALUES
  ...
  ('Teclado game 34',    'Teclado',    119.90, 15),
  ('Celular Galaxy 12',    'Movil',    2500.00, 10);
