...
('Roy', 'Torres', 'roy@correo.com', 'Iquitos'),
('Brad', 'Ruiz', 'brad@correo.com', 'Loreto');
...
('Teclado Gamer RGB', 'Accesorios', 150.00, 20),
('Lavadora Samsung', 'Electrodomesticos', 1899.00, 10);
