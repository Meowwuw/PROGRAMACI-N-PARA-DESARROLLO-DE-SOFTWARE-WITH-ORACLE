...
Porque los datos que son comunes, como el nombre, apellido, correo y teléfono, se guardan una sola vez en la tabla persona. Luego, las tablas cliente_subtipo y empleado usan el id_persona para relacionar a esa misma persona y solo guardan los datos correspondientes a cada rol. Así se evita repetir la información.
