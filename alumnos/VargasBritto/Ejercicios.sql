...
CREATE SCHEMA IF NOT EXISTS a_vargas;

-- Se ejecuta CADA VEZ que abres DBeaver:
SET search_path TO a_vargas;
...
INSERT INTO cliente (nombre, apellido, correo, ciudad) VALUES
  ('Ardey',  'Vargas',  'ardey@correo.com',  'pucallpa'),
  ('Deyar', 'Bena',   'dayben@correo.com', 'lima');

INSERT INTO producto (nombre, categoria, precio, stock) VALUES
  ('lavadora',       'electrodomesticos',    3499.00,  10),
