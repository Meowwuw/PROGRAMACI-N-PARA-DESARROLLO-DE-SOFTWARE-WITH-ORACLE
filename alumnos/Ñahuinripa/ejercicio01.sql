...
CREATE SCHEMA IF NOT EXISTS a_ñahuinripa;

-- Se ejecuta CADA VEZ que abres DBeaver:
SET search_path TO a_ñahuinripa;
...
INSERT INTO cliente (nombre, apellido, correo, ciudad) VALUES
  ...
  ('Luz', 'Vazques', 'luz@correo.com', 'Pucallpa'),
  ('Aracely', 'Pacaya', 'ara@correo.com', 'Huancayo');
...
INSERT INTO producto (nombre, categoria, precio, stock) VALUES
  ...
  ('Computadora de mesa', 'computo', 500.00, 20),
  ('Impresora', 'Preferico de salida', 350.00, 10),
