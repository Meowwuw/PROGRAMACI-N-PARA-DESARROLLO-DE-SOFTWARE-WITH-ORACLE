...
select nombre, apellido,
		initcap(nombre || ' ' || apellido) as apellido_formateado
from cliente;
...
select nombre, categoria,
		initcap(nombre || ' ' || categoria) as ficha_producto
from producto
...
select nombre,
		replace(nombre, 'Michi', 'MichiStore') as nombre_mostrado
from producto;
...
select nombre, correo,
		substring(correo from position('@' in correo)) as dominio
from cliente
where correo is not null;
...
('Martin', 'Hidalgo', 'Uncorreoxdxd@gmail.com', '923657543'),
('Fernando', 'Mamani', 'ferpe@gmail.com', '987654254' ),
('Claudio', 'Fernandez', 'clau@gmail.com', '987673456' ),
('Miguelito', 'Cordova', 'miguel@gmail.com', '965453289'),
('DaVingi', 'De Leon', 'davs@gmail.com', '908976543');
--
