CREATE SCHEMA IF NOT EXISTS a_hidalgo;
...
insert into cliente (nombre, apellido, correo, ciudad) values
  ('Pepito', 'Carloman', 'nose@correo.com', 'Ucayali'),
  ('carlos', 'valderomar', 'xd@correo.com', 'Ayacucho');
...
INSERT INTO producto (nombre, categoria, precio, stock) VALUES
  ...
  ('Mause pad', 'Accesorios', 20.50, 10),
  ('Pc gamer', 'Computo', 3000.99, 3);
