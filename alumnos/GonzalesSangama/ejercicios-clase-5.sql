...
--     RESPUESTA:-- La Alfombrilla Michi XL no aparece porque tiene la categoría NULL. 
	   -- Al usar NOT IN, los valores NULL no cumplen la condición.
select  *
from  producto
...
--      RESPUESTA:NULL representa un valor desconocido o inexistente. No se puede comparar con =.
--Para comprobar valores NULL se debe utilizar IS NULL.
